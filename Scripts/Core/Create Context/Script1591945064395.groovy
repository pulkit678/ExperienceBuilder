...
WebUI.selectOptionByValue(findTestObject('Core/Context Catalog/Create_Config select method'), 
    findTestData('Context').getValue(2, 11), true)

WebUI.setText(findTestObject('Core/Context Catalog/Create_Configuration Request JSON Schema'), 
    findTestData('Context').getValue(2, 12))

WebUI.setText(findTestObject('Core/Context Catalog/Create_Configuration Response JSON Schema'), 
    findTestData('Context').getValue(2, 13))
...
WebUI.setText(findTestObject('Core/Context Catalog/Adding_header text'), findTestData('Context').getValue(2, 14))
