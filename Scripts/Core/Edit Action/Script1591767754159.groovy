...
WebUI.selectOptionByValue(findTestObject('Core/Action Catalog/Edit_Select URL Method'), 
    'Gateway URL', true)

WebUI.setText(findTestObject('Core/Action Catalog/Edit__url'), 'https://jhdjf23')

WebUI.selectOptionByValue(findTestObject('Core/Action Catalog/Edit_Request Method'), 'GET', 
    true)
...
WebUI.setText(findTestObject('Core/Action Catalog/Edit_Configuration Request JSON Schema'), 
    '{"dfcdc":"","":""}')

WebUI.setText(findTestObject('Core/Action Catalog/Edit_Configuration Response JSON'), '{"ADFC":"","":""}')

WebUI.selectOptionByValue(findTestObject('Core/Action Catalog/Edit_Config Request Method'), 
    'POST', true)

WebUI.click(findTestObject('Core/Action Catalog/button_Next_1'))

WebUI.setText(findTestObject('Core/Action Catalog/Edit_Adding header'), 'dsjkdhsjwsdef')

WebUI.click(findTestObject('Core/Action Catalog/Edit_Save'))

WebUI.click(findTestObject('Core/Action Catalog/button_Ok'))
